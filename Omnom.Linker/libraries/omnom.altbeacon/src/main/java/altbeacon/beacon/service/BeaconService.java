...
import altbeacon.bluetooth.BluetoothCrashResolver;
            ...
            if (service != null) {
                switch (msg.what) {
                    case MSG_START_RANGING:
                        ...
                        service.startRangingBeaconsInRegion(startRMData.getRegionData(), new altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                    ...
                    case MSG_START_MONITORING:
                        ...
                        service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod());
                        break;
