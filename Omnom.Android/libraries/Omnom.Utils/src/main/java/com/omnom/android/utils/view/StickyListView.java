...
import com.omnom.android.utils.BuildConfig;
...
public class StickyListView extends ListView {
	 ...
	 */
	public static interface StickyListAdapter extends ListAdapter {
		/**
	...
	public static boolean isItemViewTypePinned(ListAdapter adapter, int viewType) {
		...
		return ((StickyListAdapter) adapter).isItemViewTypePinned(viewType);
	}
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if(BuildConfig.DEBUG && adapter != null) {
			if(!(adapter instanceof StickyListAdapter)) {
