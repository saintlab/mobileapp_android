...
public class BeaconAttributes {
	...
	public static final UUID UUID_BLE_REDBEAR_BEACON_UUID = UUID.fromString("b0702881-a295-a8ab-f734-031a98a512de");
	...
	public static final UUID UUID_BLE_REDBEAR_BATTERY_SERVICE = UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb");

	public static final UUID UUID_BLE_REDBEAR_BATTERY_LEVEL = UUID.fromString("B0702889-A295-A8AB-F734-031A98A512DE");
