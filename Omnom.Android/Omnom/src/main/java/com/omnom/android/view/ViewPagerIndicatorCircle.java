 ...
 */
public class ViewPagerIndicatorCircle extends View implements ViewPager.OnPageChangeListener {
	...
	public ViewPagerIndicatorCircle(Context context, AttributeSet attrs) {
		this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
	}

	public ViewPagerIndicatorCircle(Context context, AttributeSet attrs, int defStyle) {
