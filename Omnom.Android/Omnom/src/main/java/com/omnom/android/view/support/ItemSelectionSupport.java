package com.omnom.android.view.support;
...
/**
 * Cloned from https://github.com/lucasr/twoway-view.
 */
public class ItemSelectionSupport {
    ...
    public static ItemSelectionSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemSelectionSupport == null) {
            ...
            recyclerView.setTag(R.id.item_click_support, itemSelectionSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(R.id.item_click_support);
    }
